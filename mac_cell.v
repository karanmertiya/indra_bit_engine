...
module mac_cell (
    ...
    output reg signed [`INT32_W-1:0] psum_out   // Partial sum to bottom
);

    // Output-Stationary: The partial sum stays here during computation
    ...
    always @(posedge clk or posedge rst) begin
        if (rst) begin
            ...
            if (drain_en) begin
                ...
                psum_out <= psum_reg; // Push our result down
